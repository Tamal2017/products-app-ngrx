...
import { GetAllProductsAction, GetAllProductsActionError, ProductsActions, ProductsActionsType } from './products.action';
        ...
        () => this.effectsActions.pipe(
            ...
            mergeMap(() => {
                return this.productService.getProducts().pipe(
                    map(products => new GetAllProductsAction(products)),
